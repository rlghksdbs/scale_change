    ...
    for data in name_list:
        ...
        if 'Temple1' in file_name:
            for index in range(2, 46, 2):
                ...
                IMAGE1 = cv2.imread('../data/HD_2/sequences/' + file_name + '/{:04d}.png'.format(index))
                gt = cv2.imread('../data/HD_2/sequences/' + file_name + '/{:04d}.png'.format(index + 1))
                IMAGE2 = cv2.imread('../data/HD_2/sequences/' + file_name + '/{:04d}.png'.format(index + 2))
