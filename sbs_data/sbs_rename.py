...
def sbs_rename(out_root_path, data_path, img_save=False):

    input_path = data_path
    output_path = os.path.join(out_root_path)
...
if __name__ == '__main__':
    out_root_path = '/home/mshong/10s-3/re/'
    # data_path = '../data/14_sbs_sd_analog'
    data_path = '/home/mshong/10s-3/'
    sbs_rename(out_root_path, data_path, img_save=True)