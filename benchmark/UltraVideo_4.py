...
def UltraVideo_4_test(data_path, pkl_name, img_save=False):
    model = Model()
    ...
    tot = 0.
    psnr_dir = '../output/RIFE/' + outpath_pkl + '/UltraVideo_4/'
    ...
    for data in name_list:
        ...
        out_folder_dir = '../output/RIFE/' + outpath_pkl + '/UltraVideo_4/' + file_name
        ...
        if 'Shake' in file_name:
            for index in range(0, 148, 2):
                ...
                IMAGE1 = cv2.imread('../data/UltraVideo_4/sequences/' + file_name + '/{:04d}.png'.format(index))
                gt = cv2.imread('../data/UltraVideo_4/sequences/' + file_name + '/{:04d}.png'.format(index + 1))
                IMAGE2 = cv2.imread('../data/UltraVideo_4/sequences/' + file_name + '/{:04d}.png'.format(index + 2))
...
if __name__ == "__main__":
    UltraVideo_4_test('../data/Ultra_4_dataset/', 'flownet.pkl', img_save=True)