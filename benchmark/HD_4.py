...
def HD_4_test(data_path, pkl_name, img_save=False):
    model = Model()
    ...
    tot = 0.
    psnr_dir = '../output/RIFE/' + outpath_pkl + '/HD_4/'
    ...
    for data in name_list:
        ...
        out_folder_dir = '../output/RIFE/' + outpath_pkl + '/HD_4/' + file_name
        ...
        if 'Temple1' in file_name:
            for index in range(2, 46, 2):

                IMAGE1 = cv2.imread('../data/HD_4/sequences/' + file_name + '/{:04d}.png'.format(index))
                gt = cv2.imread('../data/HD_4/sequences/' + file_name + '/{:04d}.png'.format(index + 1))
                IMAGE2 = cv2.imread('../data/HD_4/sequences/' + file_name + '/{:04d}.png'.format(index + 2))
...
if __name__ == "__main__":
    HD_4_test('../data/HD_dataset/', 'flownet.pkl', img_save=True)