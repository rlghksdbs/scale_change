...
def sbs_60_to_30(out_root_path, data_path, img_save=False):

    input_path = data_path
    output_path = os.path.join(out_root_path, 'sbs_120fps_fhd')
    ...
    for input_clip in os.listdir(input_path):
        ...
        print('{} : previous frames {} -> current frames {}'.format(input_clip, limit, len(frame)))


if __name__ == '__main__':
    out_root_path = '../FHD_30fps'
    # data_path = '../data/14_sbs_sd_analog'
    data_path = '../data/fhd_deinteralce_png_keti'
    sbs_60_to_30(out_root_path, data_path, img_save=True)
